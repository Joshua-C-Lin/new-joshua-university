...
class MyNotes {
  ...
  events() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".delete-note").on("click", e => this.deleteNote(e));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".edit-note").on("click", e => this.editNote(e).bind(this));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".update-note").on("click", e => this.updateNote(e).bind(this));
  }
